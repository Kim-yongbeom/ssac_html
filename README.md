...
> justify-content, align-items의 방향이 flex-direction의 설정에 의해서 뒤바뀔수 있음
...
> 가로방향
>
> text-align: center; - 텍스트, 인라인
> margin-left, margin-right: auto; - 가로길이가 정해진 블럭요소
